...
partial class Program
{
    static void UsandoStreamReader()
    {
        ...
        using (var fluxoDoArquivo = new FileStream(enderecoDoArquivo, FileMode.Open))
        {
            ...
            //le todo o arquivo, mas de maneira brusca, oq pode gerar instabilidade no código
            //var texto = leitor.ReadToEnd();

            //le o primeiro caracter do arquivo
            ...
            while (!leitor.EndOfStream)
            {
                ...
                var msg = $"Conta número {contaCorrente.Numero}, ag {contaCorrente.Agencia}, Saldo {contaCorrente.Saldo} Nome: {contaCorrente.Titular.Nome}";
